...
# os.environ["WANDB_API_KEY"]='be4dd29a4d4bbe71c528f99da587dd310dbff1d7'
...
#    print(model.build_graph()[0].summary())
    ...
    # model.load_weights('models/weights/efficientnetB0_noisystudent/2022-10-24-12:59:12/cp-0160.ckpt')
